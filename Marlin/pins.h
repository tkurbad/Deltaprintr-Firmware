...
// #define RAMPS_V_1_0
  ...
  #define LARGE_FLASH true
    ...
    #define X_DIR_PIN          55
    #define X_ENABLE_PIN       38
    #define X_MIN_PIN          -1 // unused for deltabot, was 3  (was 2)
    #define X_MAX_PIN          3

    #define Y_STEP_PIN         60
    #define Y_DIR_PIN          61
    #define Y_ENABLE_PIN       56
    #define Y_MIN_PIN          -1 // unused for deltabot, was 14 (was 15)
    #define Y_MAX_PIN          14
  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #define BEEPER 33
      ...
      #define LCD_PINS_D7 29
        ...
        #define DOGLCD_A0  11
        #define DOGLCD_CS  6
        #define LCD_PIN_BL	-1	// backlight LED on PA3
...
// for the fan and Teensyduino uses a different pin mapping.
  ...
  #define Y_STOP_PIN         8
  #define Z_MAX_PIN          36  
  #define Z_MIN_PIN           0  // Plug into a thermistor for FSR sensor.
