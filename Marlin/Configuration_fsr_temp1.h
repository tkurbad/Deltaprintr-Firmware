...
#define STRING_CONFIG_H_AUTHOR "(Shai, Deltaprintr / modified by Torsten Kurbad)" // Who made the changes.
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  // If commented they are wired to heated bed thermistor input.
...
#define MANUAL_Z_HOME_POS 317.8 // E3Dv6 all metal hotend + heated bed setting (modified FSR standoffs)
...
#define CARBON_PREHEAT_HOTEND_TEMP 255
#define CARBON_PREHEAT_HPB_TEMP 60
#define CARBON_PREHEAT_FAN_SPEED 255
